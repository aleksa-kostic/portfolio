...
Both the web crawling and search engine projects were done in collaboration with Taylor James Fialkowski (tfialkow@uci.edu) 
in our information retrieval course at UCI taught by professor Mustafa Ibrahim in winter quarter of 
the 2021-2022 academic year. 

The final product for the search engine project is within the Search Engine with GUI folder. This project can be executable by the
following steps:
